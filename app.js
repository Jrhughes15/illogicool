...
const projects = [
  ...
  },
  {
    id: "watch-window",
    title: "Watch Window",
    summary: "A program that helps you find YouTube videos that match your topic and fit the exact time you have, with inline playback and smart filters for length, quality, and popularity.",
    tags: [
      "Tool",
      "Entertainment",
      "Utility"
